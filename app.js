(() => {
  ...
  const PATCH_VERSION = "v144-bubble-text-right";
  const PATCH_STATUS_LABEL = "v144・釣りニャン吹き出し文字右寄せ調整版";
  ...
  function showLoadError(error) {
    console.error("Mie Fishing Map v144 loader failed", error);
  ...
  function patchSource(source) {
    let patched = source
      ...
      .replace('// v131: 中勢グリーンパーク池も除いた初期収録。', '// v144: 吹き出し文字を右寄せして内側に収まるよう調整。')
