...
const POSITION_STORAGE_KEY = "mie-fishing-map-position-overrides-v4";
...
const AUTO_ALIGN_STORAGE_KEY = "mie-fishing-map-auto-align-v4";
...
async function lookupGsiVectorLabelCandidates(spot, thorough = false) {
  ...
  // 地理院地図の文字表示に近づけるため、標準地図で使われる注記タイルを複数ズームで探します。
  // 以前は z15 だけを見ていたため、詳細表示時の文字位置とズレる場所が残っていました。
